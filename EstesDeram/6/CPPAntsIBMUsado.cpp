...
static double const Turn_off_random = 0.;
...
//  Lambda seria 2.
static double const Lambda = 5.;        //  0.5
...
static double const delta_t = 0.0005;   //     0.005
...
////////////////////////////
static double const PheroNarrow = 3.;
...
double ForceX(double AntXpos,double  AntYpos,double  AntVelX, double  AntVelY)
{
    ...
    * sin(2.*Angle(AntVelX,AntVelY));
    ...
    aux = (1./3.) * pow(SENSING_AREA_RADIUS,3.) * Lambda * cos(Angle(AntVelX,AntVelY))
...
double ForceY(double AntXpos,double  AntYpos,double  AntVelX, double  AntVelY)
{
    ...
    * sin(2.*Angle(AntVelX,AntVelY));
    ...
    aux = (1./3.) *  pow(SENSING_AREA_RADIUS,3.) * Lambda * sin(Angle(AntVelX,AntVelY))
    * PheromoneConcentration(AntXpos,AntYpos) * sin(SensingAreaHalfAngle)
    + (1./4.)*pow(SENSING_AREA_RADIUS,4.) * Lambda
